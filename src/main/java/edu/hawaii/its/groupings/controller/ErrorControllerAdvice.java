 ...
 public class ErrorControllerAdvice {
     ...
     public ResponseEntity<ApiError> handleExceptionForTesting(ExceptionForTesting e, WebRequest request) {
         String path = request.getDescription(false);
         emailService.sendWithStack(e, "Exception For Testing", path);

         ApiError.Builder errorBuilder = new ApiError.Builder()
                 .status(HttpStatus.INTERNAL_SERVER_ERROR)
                 .message("Exception For Testing")
                 .debugMessage(e.getMessage())
                 .timestamp(LocalDateTime.now());
