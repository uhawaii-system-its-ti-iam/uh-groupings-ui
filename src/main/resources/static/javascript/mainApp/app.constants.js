...
UHGroupingsApp.constant("Message", {
  ...
  Body: {
    ...
    ADD_MEMBER: {
      with: (member, listName) =>
        `${member} has been successfully added to the ${listName} list.`,
    },
    ADD_MEMBERS: {
      with: (listName) =>
        `All members have been added successfully to the ${listName} list.`,
    },
    ADD_GROUP_PATH: {
      with: (groupingName, listName) =>
        `${groupingName} has been successfully added to the ${listName} list.`,
    },
    ADD_CURRENT_PATH_ERROR:
      "Adding a grouping to its own owners list is not allowed.",
    REMOVE_MEMBER: {
      with: (member, listName) =>
        `${member} has been successfully removed from the ${listName} list.`,
    },
    REMOVE_MEMBERS: {
      with: (listName) =>
        `All selected members have been successfully removed from the ${listName} list.`,
    },
    REMOVE_GROUP_PATH: {
      with: (groupingName, listName) =>
        `${groupingName} has been successfully removed from the ${listName} list.`,
    },
    OWNER_NOT_ADDED:
      "Department accounts may not be assigned ownership due to accountability and lifecycle issues.  Please contact the IAM team, <its-iam-help@lists.hawaii.edu>, if there are any questions.",
    DISPLAY_OWNERS_ERROR: "There was an error displaying the owners.",
    INVALID_EMAIL_ERROR: "Please enter a valid email address.",
    ADD_GROUP_PATH_ERROR:
      "Groupings can only be added to the owners list as owner-groupings",
  ...
  SyncDestModal: {
    confirmationMessage: (isSingular) =>
      `Are you sure you want to toggle the synchronization ${
        isSingular ? "destination" : "destinations"
      }?`,
  },
  OptPreferencesModal: {
    confirmationMessage: (isSingular) =>
      `Are you sure you want to change opt ${
        isSingular ? "preference" : "preferences"
      }?`,
  },
});
